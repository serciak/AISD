...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        wpiszOcene(studenci, 6, 4.5);
        wpiszOcene(studenci, 3, 3.5);
        wpiszOcene(studenci, 5, 3);
        wpiszOcene(studenci, 10, 2.5);

        wyswietlStudentow(iterator);
        wyswietlZaliczonych(new FilterIterator<Student>(new ArrayIterator<>(studenci), new predykatZaliczeni()));
        wyswietlNieZaliczonych(new FilterIterator<Student>(new ArrayIterator<>(studenci), new predykatNieZaliczeni()));
    }
}
